...
export const queryURL ='http://localhost:3300/movies/searchMovie';
export const top_rated='http://localhost:3300/movies/allMovies';
export const createSession='http://localhost:3300/user/createSession';